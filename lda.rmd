## Handout 8 Classification
LDA


Cross Validated Predictions/Accuracy
```{r, warning = FALSE}
set.seed(1234)
K = 10
...
for (i in 1:length(thresholds)){
  ...
  accuracy[i] <- mean((pred - (as.numeric(heart_no_na$HeartDiseaseorAttack)-1))^2)
...
```{r}
set.seed(1234)
pred <- ifelse(predictions > 0.06, 1, 0)
...
plot(perf, colorize = TRUE, main = "LDA")
